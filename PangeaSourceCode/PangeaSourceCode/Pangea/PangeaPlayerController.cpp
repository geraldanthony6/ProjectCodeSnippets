...
void APangeaPlayerController::SetupInputComponent()
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(InputComponent))
	{
		...
		// Setup attack input event
		EnhancedInputComponent->BindAction(AttackInputAction, ETriggerEvent::Started, this, &APangeaPlayerController::OnAttackPressed);
	}
	else
	{
...
void APangeaPlayerController::OnSetDestinationReleased()
{
	...
	{
		GEngine->AddOnScreenDebugMessage(1, 1.0f, FColor::Red, TEXT("Move called"));
...
void APangeaPlayerController::OnAttackPressed()
{
	...
	auto playerAvatar = Cast<APangeaCharacter>(GetPawn());
	if(playerAvatar->CanAttack())
	{
		GEngine->AddOnScreenDebugMessage(1, 1.0f, FColor::Red, TEXT("Attack called"));
		playerAvatar->Attack();
	}
}
